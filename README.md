...
- **Metric Selector**: Choose which rating to analyze, including Overall Rating, Cabin Staff, Food, Entertainment, Ground Service and Seat Comfort
- **Date Range Filter**: Use the slider to view ratings across any period between March 2016 and October 2023
...
*(Filtered dashboard view for the United Kingdom)*
...
*(Filtered dashboard view for COVID period)*
...
*(Filtered dashboard view for 2022)*
- Monthly ratings decline steadily through the first half of 2022, reaching their lowest in August, before recovering in the fall.
